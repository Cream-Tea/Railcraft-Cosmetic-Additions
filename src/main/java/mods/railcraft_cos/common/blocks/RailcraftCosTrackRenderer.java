...
public class RailcraftCosTrackRenderer implements ISimpleBlockRenderingHandler {
	...
	public int getRenderColor(int p_149741_1_){ return ColorizerGrass.getGrassColor(0.5D, 1.0D);}
	public int colorMultiplier(IBlockAccess world, int x, int y, int z) { return world.getBiomeGenForCoords(x, z).getBiomeGrassColor(z, y, z);};
	public IIcon getIcon(int a, int b){return Blocks.tallgrass.getIcon(a, b);}};
